...
abund <- fread(file = "figures/2023-12-24_paper_figures/Rohwer_Figure_2_data/less_diverse_bloom-ME2011-09-04_3300044729_group3_bin142.csv")
ave <- fread(file = "figures/2023-12-24_paper_figures/Rohwer_Figure_2_data/less_diverse_bloom_1mo_moving_average-ME2011-09-04_3300044729_group3_bin142.csv")
...
fill.btwn.lines(X = ave[num.obs.abund > 0, center], Y1 = ave[num.obs.abund > 0, ave.abund + sd.abund], Y2 = ave[num.obs.abund > 0, ave.abund - sd.abund], Color = adjustcolor("grey40", .3))
