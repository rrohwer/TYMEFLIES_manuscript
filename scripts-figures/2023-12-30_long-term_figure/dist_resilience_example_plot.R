...
dist.first <- fread(file = "figures/2023-12-24_paper_figures/Rohwer_Figure_3_data/snv_dist_table-disturbance-ME2015-07-03_3300042555_group6_bin161-.csv", colClasses = c("date.1" = "character","date.2" = "character"))
...
mtext(text = "Disturbance/Resilience", side = 3, at = parse_date_time(x = paste(2000,10,1), orders = "ymd"), line = -2, adj = 0)
