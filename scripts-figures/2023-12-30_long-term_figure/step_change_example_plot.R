...
dist.first <- fread(file = "figures/2023-12-24_paper_figures/Rohwer_Figure_3_data/snv_dist_table-step-ME2011-09-21_3300043464_group3_bin69-.csv", colClasses = c("date.1" = "character","date.2" = "character"))
...
mtext(text = "Step Change", side = 3, at = parse_date_time(x = paste(2000,10,1), orders = "ymd"), line = -2, adj = 0)
