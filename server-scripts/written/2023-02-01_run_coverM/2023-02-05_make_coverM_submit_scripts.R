...
# want to compare mapping with different amts of contig ends excluded
# do mean for the mapping-to-contig with ends cut comparison
# later can make one that does relative abundance and excludes top/bottom 5 % too, for final table to use.
