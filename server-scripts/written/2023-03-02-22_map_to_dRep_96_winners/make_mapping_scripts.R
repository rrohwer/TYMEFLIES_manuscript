...
file.map.slurm <- "server-scripts/generated/2023-03-02-22_map_to_dRep_96_winners/map_to_drep.slurm"
file.map.launcher <- "server-scripts/generated/2023-03-02-22_map_to_dRep_96_winners/map_to_drep.launcher"

file.sort.slurm <- "server-scripts/generated/2023-03-02-22_map_to_dRep_96_winners/sort_drep_sams.slurm"
file.sort.launcher <- "server-scripts/generated/2023-03-02-22_map_to_dRep_96_winners/sort_drep_sams.launcher"

file.delete.sams <- "server-scripts/generated/2023-03-02-22_map_to_dRep_96_winners/delete_sams.sh"
...
for(s in sample.names){
  map.launcher <- c(map.launcher,
                    paste0("module load bbmap; bbmap.sh in=",
                           paste0("../filtered_reads/",s),"_filtered-reads.fastq.gz ",
                           "out=",s,".sam 32bit=t"))
}
